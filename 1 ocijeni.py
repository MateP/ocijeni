...
if __name__ == '__main__':
    try:
        ...
        Popravi_kod_zadatak(root, lista, kod2jmbag, jmbag2kod, BROJ_ZADATAKA, lista_brisani, dir_path, dir_skenovi)
        ...
        if len(nebodovani)>0:
            ...
            Obradi_nebodovane(root, nebodovani, lista, kod2jmbag, jmbag2kod, BROJ_ZADATAKA, lista_brisani, dir_skenovi)
                ...
                if kod not in [BRISAN_,KOD_NEPOZNAT_]:
                    ...
                    for zad in range(1,BROJ_ZADATAKA+1):
                        ...
                        if len(bodovi)>1:
                            ...
                            kolizija(root, student.zadaci_index[zad], lista, kod2jmbag, jmbag2kod, BROJ_ZADATAKA, lista_brisani, dir_skenovi)
                            mijenjan_kod = update_Studenti(Studenti,kod,zad,lista,lista_brisani,BROJ_ZADATAKA,kod2jmbag)
                            if mijenjan_kod:
                                ...
                                za_provjeriti = [izz for zz in Studenti[kod].zadaci_index for izz in Studenti[kod].zadaci_index[zz]]
                                provjeri_osobu(root, za_provjeriti, kod, Studenti, lista, kod2jmbag, jmbag2kod, BROJ_ZADATAKA, lista_brisani, dir_skenovi)
        ...
        Generiraj_datoteke_za_upload(root, lista, Studenti, dir_path, dir_skenovi, BROJ_ZADATAKA, kod2jmbag)
